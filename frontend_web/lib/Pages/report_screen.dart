        ...
        child: Column(
          ...
          children: [
            ...
            if (status.toLowerCase() == 'retenido') ...[
              ...
              Center(
                child: _buildTextBox('Instrucciones para Sacar el Vehículo',
                    'PUEDE LIBERAR SU VEHICULO VISITANDO EL CENTRO DE RETENCION DE VEHICULOS DE PROGRAMA "PARQUEATE BIEN" UBICADO EN LA AVENIDA TIRADENTES #17, SECTOR NACO, EN HORARIOS D 8:00AM a 7:00PM '),
              ),
            ],
          ],
        ),
